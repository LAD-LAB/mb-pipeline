...
```{r}
print('trnL')
print(paste0('sbatch --mail-user=',email,' ',scripts.dir,'/count-reads.sh ',dirname(demux.dir),'/',format(Sys.Date(),'%Y%m%d'),'_trnL_output', ' ', qiime.container
))
print('12SV5')
print(paste0('sbatch --mail-user=',email,' ',scripts.dir,'/count-reads.sh ',dirname(demux.dir),'/',format(Sys.Date(),'%Y%m%d'),'_12SV5_output', ' ', qiime.container
))
```
