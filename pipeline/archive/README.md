> **Note:** This is the legacy version of the pipeline README, preserved for reproducibility. For the current pipeline using `foodseq.tools`, see the [main pipeline README](../README.md) and the [FoodSeq Handbook](https://lad-lab.github.io/pipeline.html).
